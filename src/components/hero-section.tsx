                        ...
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            <AnimatedGroup
                                variants={{
                                    ...
                                    ...(transitionVariants as any), // 🔥 force TS safe
                                }}
                                className="mt-12"
                            >
                ...
                <div className="space-y-3">
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-foreground text-xl font-medium">8,081</span>
                    ...
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-foreground text-xl font-medium">5,412</span>
                            <span className="text-muted-foreground text-xs">Steps/day</span>
                        </div>
